 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "einarbaumann.com", ownerName = "einarbaumann.com", packagePath = "sharedexpenses2"))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyBplWU35v2C-MuIHhuGk6o6SrgUappdzvU";

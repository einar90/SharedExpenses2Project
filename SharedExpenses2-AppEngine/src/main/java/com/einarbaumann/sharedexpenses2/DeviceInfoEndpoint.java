...
import com.einarbaumann.sharedexpenses2.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "einarbaumann.com", ownerName = "einarbaumann.com", packagePath = "sharedexpenses2"))
